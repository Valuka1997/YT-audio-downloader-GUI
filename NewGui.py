...
def info():
    messagebox.showinfo("Info","You Can Paste the YouTube video URL and download the file as mp3 audio in to the folder which contains the program")
...
title1["text"] = "Download YouTube Video as Audio Files"
